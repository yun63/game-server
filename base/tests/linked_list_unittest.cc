/// =====================================================================================
/// 
///    @filename         :  linked_list_unittest.cc
/// 
///    @description      :  单元测试：链表
/// 
///    @version          :  1.0
///    @created          :  2014年09月28日 16时16分07秒
///    @revision         :  none
///    @compiler         :  g++
/// 
...
{
    public:
        MultipleInheritanceNodeBase() : field_takeing_up_space_(0) {}
        int field_takeing_up_space_;
};
...
TEST(LinkedList, Append)
{
...

    {
        ...
        ExpectListContents(list, ARRAY_SIZE(expected), expected);
    }
